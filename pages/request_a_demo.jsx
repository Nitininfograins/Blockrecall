...
export default function FindMySolution() {
  ...
  async function stepper(userData) {
    // https://form-b l o c k r e c a l l-api.onrender.com/visitor?
    ...
    axios({
      method: "post",
      url: `https://form-b l o c k r e c a l l-api.onrender.com/visitor`,
      data: data,
                      ...
                      <Col lg={6}>
                        <div className="welcome_content">
                          <div className="welcome_section">
                            <h2>
                              Hi, my name is Avatar and I'm here to help you
                              find the right solution for your needs!{" "}
                            </h2>
                            <h2>
                              I'll ask a few questions to make sure I understand
                              you and your goals.
                            </h2>
                            <button
                              onClick={() => {
                    ...
                    {activeStep + 1 === steps.length ? (
                              ...
                              <Row>
                                ...
                                <Col lg={6}>
                                  <div className="question_box_name">
                                    <h4>
                                      Thanks for your interest in the B L O C K
                                      R E C A L L Platform.
                                    </h4>
                                    <h4>
                                      I've passed your details to an Slicelegend
                                      who is going to set up a time to connect
                                      with you.
                                    </h4>
                                    <div>
                                      <Link
                                        href={"/"}
                                        className="btn stp_inner_btn"
                                      >
                                        Back to B L O C K R E C A L L
                                      </Link>
                                    </div>
                                  </div>
                                </Col>
                      ...
                      <React.Fragment>
                        <Typography sx={{ mt: 2, mb: 1 }}>
                          {activeStep + 1 === 2 ? (
                            <>
                              <div className="question_box_name">
                                <h4>
                                  2. How would you best describe your role in
                                  the diamond industry? *
                                </h4>
                                <p>
                                  If more than one applies, please select the
                                  primary industry
                                </p>
                                <div>
                                  <button
                                    className="btn stp_inner_btn que2Cate"
                                    onClick={(e) => Que2(e)}
                                  >
                                    Miner
                                  </button>
                                  <button
                                    className="btn stp_inner_btn mx-3 que2Cate"
                                    onClick={(e) => Que2(e)}
                                  >
                                    Manufacturer
                                  </button>
                                  ...
                                  <button
                                    className={`btn stp_inner_btn mx-3 ${
                                      ConfirmBtn2 ? "" : "d-none"
                                    }`}
                                    onClick={Que2OK}
                                  >
                            ...
                            <>
                              <div className="question_box_name">
                                <h4>
                                  3. "The most important outcomes for me in
                                  using the sliiceledger Platform are..." *
                                </h4>
                                ...
                                <div className="d-flex inputDiv">
                                  <input
                                    ...
                                    className="form-control Que3Input"
                                  />
                                  <button
                                    className="btn stp_inner_btn my-2"
                                    onClick={Que3}
                                  >
                                    Ok
                                  </button>
                            ...
                            <>
                              <div className="question_box_name">
                                <h4>
                                  4. Do you agree with the following sentence?:
                                  "I'm not really looking to find new suppliers,
                                  I just want to display diamonds with
                                  provenance on my own website" *
                                </h4>
                                <div>
                                  <button
                                    className="btn stp_inner_btn que4Cate"
                                    onClick={(e) => Que4(e)}
                                  >
                                    Yes
                                  </button>
                                  <button
                                    className="btn stp_inner_btn mx-3 que4Cate"
                                    onClick={(e) => Que4(e)}
                                  >
                                    No
                                  </button>
                              ...
                              <Container>
                                <Row>
                                  ...
                                  <Col lg={6}>
                                    <div className="question_box_name">
                                      <h4>
                                        5. I've got something great for you.
                                        Amplify allows you to connect live
                                        inventory to your website so you can
                                        offer provenance to your market
                                      </h4>
                                      <div className="d-flex flex-column">
                                        <button
                                          className="btn stp_inner_btn my-2 que5Cate"
                                          onClick={(e) => Que5(e)}
                                        >
                                          Amplify sounds perfect for me
                                        </button>
                                        <button
                                          className="btn stp_inner_btn my-2 que5Cate"
                                          onClick={(e) => Que5(e)}
                                        >
                                          I need to speak with someone to
                                          discuss my needs
                                        </button>
                                        <button
                                          className={`btn stp_inner_btn my-2 ${
                            ...
                            <>
                              <div className="question_box_name">
                                <h4>
                                  6. What's your business email address?.{" "}
                                </h4>
                                <p>
                                  We use this to register your account and from
                                  time to time, we would also like to contact
                                  you about our products and services, as well
                                  as other content that may be of interest to
                                  you.
                                </p>
                                <p>
                                  You can unsubscribe from these communications
                                  at any time. For more information on how to
                                  unsubscribe, our privacy practices, and how we
                                  are committed to protecting and respecting
                                  your privacy, please review our Privacy
                                  Policy.
                                </p>
                                <input
                                  type="email"
                                  className="form-control Que6Input"
                            ...
                            <>
                              <div className="question_box_name">
                                <h4>
                                  7. What country are you (or your company)
                                  based in?{" "}
                                </h4>
                                <p>e.g. Australia, USA, Israel, Indonesia</p>
                                <input
                                  type="text"
                                  className="form-control Que7Input"
                                  placeholder="Type your answer here..."
                                />
                                <div>
                                  <button
                            ...
                            <>
                              <div className="question_box_name">
                                ...
                                <input
                                  type="text"
                                  className="form-control Que8Input"
                                  placeholder="Type your answer here..."
                                />
                                <div>
                                  <button
                            ...
                            <>
                              <div className="question_box_name">
                                ...
                                <input
                                  type="text"
                                  className="form-control Que9Input"
                                  placeholder="Type your answer here..."
                                />
                                <div>
                                  <button
                            ...
                            <>
                              <div className="question_box_name">
                                <h4>
                                  10. And lastly, what's the name of your
                                  company?*{" "}
                                </h4>
                                <input
                                  type="text"
                                  className="form-control Que10Input"
                                  placeholder="Type your answer here..."
                                />
                                <div>
                                  <button
                            ...
                            <>
                              <div className="question_box_name">
                                ...
                                <div>
                                  <button
                                    className="btn stp_inner_btn mx-2"
                                    onClick={(e) => Que1(e)}
                                  >
                                    Diamond
                                  </button>
                        ...
                        >
                          ...
                          <Button
                            className="stp_btn nextBtn d-none"
                            onClick={handleNext}
                          >
