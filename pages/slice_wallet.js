...
const wallet = () => {
  return (
    <>
      <Head>
        <title>
          Slice Crypto Wallet & Extension - B L O C K R E C A L L Wallet
        </title>
        <meta
          name="description"
          content="Slice Crypto Wallet & Extension from Sliceleder Wallet, An open-source platform, which is easy-to-use to create new wallets and many more cool features."
        />
      </Head>
