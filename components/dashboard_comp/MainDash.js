...
const MainDash = () => {
  ...
  //   SliceTokenABiWthiCONTRACT = new web3_Stake.eth.Contract(
  //     SliceTOKEN_Abi,
  //     SliceTOKEN_CONTACT_ADDRESS
  //   );
  //   StakingUnstakingABiWthiCONTRACT = new web3_Stake.eth.Contract(
  ...
  //   });
  //   StakingUnstakingABiWthiCONTRACT.methods
  //     .rate()
  //     .call()
  ...
  //     .approve(STAKINGUNSTAKING_CONTACT_ADDRESS, stakeToken_wei)
  //     .send({
  //       from: walletAddress,
  //     })
  ...
  //         var ethtoken_balance = Web3.utils.fromWei(
  ...
  //       StakingUnstakingABiWthiCONTRACT.methods
  //         .rewardOf(walletAddress)
  //         .call()
  //         .then(async function (rewardOf) {
  //           setWeiRewardToken(rewardOf);
  //           var eth_rewardToken = Web3.utils.fromWei(
  //             rewardOf.toString(),
  //             "ether"
  //           );
  ...
  //         var eth_totalStakeToken = Web3.utils.fromWei(
  //           wei_totakStakeToken.toString(),
  //           "ether"
  //         );
  ...
  //           var s_hours =
  //             ((s_date.getHours() % 12 || 12) < 10 ? "0" : "") +
  //             (s_date.getHours() % 12 || 12);
  //           var s_minutes =
  //             (s_date.getMinutes() < 10 ? "0" : "") + s_date.getMinutes();
  ...
  //           var uf_hours =
  //             ((uf_date.getHours() % 12 || 12) < 10 ? "0" : "") +
  //             (uf_date.getHours() % 12 || 12);
  //           var uf_minutes =
  //             (uf_date.getMinutes() < 10 ? "0" : "") + uf_date.getMinutes();
  ...
  // var s_hours1 =
  //   ((s_date1.getHours() % 12 || 12) < 10 ? "0" : "") +
  //   (s_date1.getHours() % 12 || 12);
  // var s_minutes1 =
  //   (s_date1.getMinutes() < 10 ? "0" : "") + s_date1.getMinutes();
  // var s_meridiem1 = s_date1.getHours() >= 12 ? "PM" : "AM";
  // var startDateTime_now1 =
  //   s_day1 +
  //   " " +
  //   s_month1 +
  //   "," +
  ...
  // var f_hours1 =
  //   ((futureDate1.getHours() % 12 || 12) < 10 ? "0" : "") +
  //   (futureDate1.getHours() % 12 || 12);
  // var f_minutes1 =
  //   (futureDate1.getMinutes() < 10 ? "0" : "") + futureDate1.getMinutes();
  ...
  //       <div
  //         className="content-wrapper farm-pg-ctnt "
  ...
  //                 }}
  //               >
  //                 <b>Note</b> : You have to stake for minimum one month to get
  //                 rewards
  //               </p>
  //             </div>
  //             <div className="col-sm-5">
  //               <div
  //                 className="home-box aos-init aos-animate"
  //                 data-aos="zoom-in"
  //               >
  ...
  //                       </div>
  //                       <div className="col-7  col-md-7">
  //                         <span className="start_time fr">
  //                           {StakingDates ? startDateTime : "DD:MM:YYYY HH:MM"}
  //                         </span>
  //                       </div>
  //                       <div className="col-5  col-md-5">
  ...
  //                       </div>
  //                       <div className="col-7  col-md-7">
  //                         <span className="finish_time fr">
  //                           {StakingDates ? finishDateTime : "DD:MM:YYYY HH:MM"}
  //                         </span>
  //                       </div>
  //                       <div className="col-5  col-md-5">
  ...
  //                       </div>
  //                       <div className="col-7  col-md-7">
  //                         <span className="fr total_bharat_token">
  //                           {ethSliceTokenBalance} Slice
  //                         </span>
  //                       </div>
  //                       <div className="col-12 col-md-12 mt-2">
  //                         <input
  //                           id="numberOfstakeTokens"
  //                           className="form-control input-lg"
  //                           min={1}
  //                           placeholder="Enter token"
  //                           type="number"
  //                           name="number"
  //                           onKeyUp={checkStakeToken}
  //                           value={stakeToken}
  //                           onChange={(e) => setStakeToken(e.target.value)}
  //                         />
  //                         <p className="text-danger" id="stakeTokenCheck">
  //                           Please Enter Number of stake token{" "}
  //                         </p>
  //                         <p
  //                           className="text-danger"
  //                           id="checkSliceTokenBalance"
  //                         >
  //                           Not enough BHARAT tokens in your wallet, please try
  //                           lesser amount
  //                         </p>
  //                         <p
  //                           className="text-danger"
  //                           id="checkStakeTokenBalance"
  //                         >
  //                           You cann't stake token.First unstake token
  //                         </p>
  //                       </div>
  //                       <div className="col-12 col-md-12 mt-2">
  //                         <button
  ...
  //                       </div>
  //                       <div className="col-7  col-md-7">
  //                         <span className="stake_time fr">
  //                           {StakingDates ? stakeDateTime : "DD:MM:YYYY HH:MM"}
  //                         </span>
  //                       </div>
  //                       <div className="col-5  col-md-5">
  ...
  //                       </div>
  //                       <div className="col-7  col-md-7">
  //                         <span className="unstake_time fr">
  //                           {StakingDates
  //                             ? unStakeDateTime
  //                             : "DD:MM:YYYY HH:MM"}
  //                         </span>
  ...
  //                       </div>
  //                       <div className="col-7  col-md-7">
  //                         <span className="your_stake fr">
  //                           {ethtotalStakeToken} Slice
  //                         </span>
  //                       </div>
  //                       <div className="col-5  col-md-5">
  ...
  //                       </div>
  //                       <div className="col-7  col-md-7">
  //                         <span className="your_reward fr">
  //                           {ethRewardToken} Slice
  //                         </span>
  //                         <input
  //                           type="hidden"
  //                           name="stakeReward"
  //                           value=""
  //                           className="stakeReward"
  //                         />
  //                       </div>
  //                       <div className="col-12 col-md-12 mt-2">
  //                         <input
  //                           id="numberOfunstakeTokens"
  //                           className="form-control input-lg stakeReward"
  //                           type="number"
  //                           name="number"
  //                           readOnly
  //                           value={ethRewardToken}
  //                         />
  //                         <p
  //                           className="text-danger"
  //                           id="checkUnstakeTokenBalance"
  //                         >
  //                           No token stacked, please first stake the token
  //                         </p>
  //                       </div>
  //                       <div className="col-12 col-md-12 mt-2">
  //                         <button
  //                           type="submit"
  //                           className="btn connect btn-block unstakingBtn"
  //                           onClick={unStaking}
  //                         >
  //                           Unstake
  //                         </button>
