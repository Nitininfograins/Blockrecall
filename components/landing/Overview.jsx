          ...
          <Row>
            <Col lg={12}>
              <div className="head">
                <h2>Overview</h2>
                <p>
                  B L O C K R E C A L L chain is powering the decentralized
            ...
            <Col lg={12}>
              {/* <div className="image_wrapper">
                <Image src={BgImg.src} alt="b L O C K R E C A L L" fluid />
        ...
        <Modal.Body>
          <div className="overview_video">
            <iframe
              width="1280"
              height="720"
              src="https://www.youtube.com/embed/XouvjkroYas"
              title="Slice Ledger Blockchain Network - An Overview"
              frameborder="0"
