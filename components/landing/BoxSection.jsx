        ...
        <Container>
          <Row>
            <div className="heading_area">
              ...
              <p>
                B L O C K R E C A L L Chain is built to enhance the on-chain
                decentralized experience and scale up the decentralized economy
              </p>
            </div>
          </Row>
              ...
              <div className="outer_wrap">
                ...
                <div className="box">
                  ...
                  <p>
                    ...
                    languages, standards, enterprise adoption
                  </p>
                </div>
              </div>
            </Col>
            ...
            <Col lg={4} md={6} sm={12} className="col_wrap">
              <div className="outer_wrap">
                ...
                <div className="box">
                  ...
                  <p>
                    Perform a transaction in no time with the network capable of
                    processing as high as 100000 transactions per second.
                  </p>
                </div>
              </div>
            </Col>
            <Col lg={4} md={6} sm={12} className="col_wrap">
              <div className="outer_wrap">
                ...
                <div className="box">
                  ...
                  <h4>Lower Cost</h4>
                  <p>
                    The cost of a transaction is almost zero yet in superfast
                    speed and inexpensive deployment of smart contracts with
