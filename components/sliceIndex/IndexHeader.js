        ...
        <header className="header_wrap fixed-top nav_bg">
          <div className="container-fluid">
            <nav className="navbar navbar-expand-lg">
              ...
              >
                <span className="ion-android-menu" onClick={handleopen}>
                  <AiOutlineBars />
                </span>
              </button>
              <div
              ...
              >
                <ul className="navbar-nav m-auto">
                  ...
                  >
                    {" "}
                    <Link className="nav-link active" href="/Slice_index">
                      Home
                    </Link>
                  </li>
                  <li
                  ...
                  >
                    <a
                      className="nav-link page-scroll nav_item nav_link_clr"
                  ...
                  >
                    <Link
                      ...
                      className="nav-link page-scroll nav_item nav_link_clr buy_Slice_link"
                    >
                      Buy Slice
                    </Link>
                  </li>
