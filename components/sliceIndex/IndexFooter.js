  ...
  return (
    <>
      <section className="indexFooter_wrap">
        <footer id="footer">
          <div
            className="top_footer light_blue_dark_bg footer_new_bg pb-2"
            data-z-index="1"
            data-parallax="scroll"
            data-image-src="assest/website/images/footer_bg.png"
          >
            <div className="container">
              <div className="row">
                <div className="col-lg-3 col-md-4 res_md_mt_30 res_sm_mt_20">
                  <div
                    className="footer_logo mb-3 animation animated fadeInUp"
                  ...
                  >
                    <a href="#home_section" className="page-scroll">
                      <img
                        className="logo_light outer_glow"
                        alt="logo"
                        src={Slice_logos.src}
                      />
                    </a>
                  ...
                  <div className="footer_desc home_footer">
                    ...
                    >
                      ...
                      transaction fee payment, and network security for the B L
                      O C K R E C A L L Chain.
                    </p>
                  </div>
                </div>
                <div className="col-lg-3 col-md-4 res_md_mt_30 res_sm_mt_20">
                  <h4
                    className="footer_title border_title animation home_footer_title animated fadeInUp"
                    data-animation="fadeInUp"
                    data-animation-delay="0.2s"
                    style={{ animationDelay: "0.2s", opacity: "1" }}
                  >
                  ...
                  <ul className="footer_link list_arrow home_footer_link">
                    ...
                    >
                      <a
                        href="https://b l o c k r e c a l l.io/b l o c k r e c a l l_whitepaper.pdf"
                        target="_blank"
                      >
                        <FiChevronRight /> Whitepaper
                      </a>
                    </li>
                ...
                <div className="col-lg-5 col-md-4 res_md_mt_30 res_sm_mt_20">
                  <div className="newsletter_form home_footer_frm" id="news">
                    ...
                    <form
                      className="subscribe_form animation home_footer_subfrm animated fadeInUp"
                      style={{ animationDelay: "0.4s", opacity: "1" }}
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  <ul className="list_none footer_menu">
                    <li>
                      <a href="https://b l o c k r e c a l l.io/static/media/PrivacyPolicyb l o c k r e c a l l.c7604fe02954ee90c4b3.pdf">
                        Privacy Policy
                      </a>
                    </li>
                    <li>
                      <a href="https://b l o c k r e c a l l.io/term_and_condition/">
                        Terms &amp; Conditions
                      </a>
                    </li>
                  </ul>
