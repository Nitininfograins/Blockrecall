...
const IndexContact = () => {
  ...
  const onSubmit = (data) => {
    ...
    axios({
      method: "post",
      url: "https://b l o c k r e c a l l.io/backend/api/equireMail",
      data: bodyFormData,
    ...
    <>
      <section className="indexContact_wrap">
        <div
          ...
          style={{ padding: "100px 0 35px 0 !important" }}
        >
          <div className="container">
            <div className="row">
              <div className="col-lg-6 col-md-12 pr-0 res_md_pr_15">
                <div
                  className="light_blue_dark_bg contact_box animation animated fadeInLeft"
                  ...
                  <ul className="list_none contact_info mt-margin">
                    ...
                    >
                      ...
                      <div className="contact_detail">
                        {" "}
                        <span>Email-id</span>
                        <p>info@b l o c k r e c a l l.io</p>
                      </div>
                    </li>
                  </ul>
                  <div className="contct_follow large_space">
                    <span
                      className="text-uppercase animation animated fadeInUp"
                      data-animation="fadeInUp"
                      data-animation-delay="0.2s"
                      style={{ animationDelay: "0.2s", opacity: "1" }}
                    >
                    ...
                    <ul className="list_none social_icon">
                      ...
                      >
                        <a
                          href="https://twitter.com/LedgerSlice"
                          target="_blank"
                        >
                          <i>
                            <AiOutlineTwitter />
              ...
              <div className="col-lg-6 col-md-12 pl-0 res_md_pl_15">
                <div
                  className="blue_lightdark_bg contact_box animation animated fadeInRight"
                ...
                >
                  ...
                  >
                    <div className="row">
                      ...
                      >
                        <input
                          ...
                          {...register("email", {
                            ...
                            pattern: {
                              value:
                                /[A-Za-z0-9]+@[A-Za-z0-9.-]+[A-Z|a-z]{2,}/my,
                      ...
                      <div
                        className="col-md-12 text-center animation animated fadeInUp"
                        data-animation="fadeInUp"
