          ...
          <section className="copyright_section">
            {/* <div className="footer_social_links_wrap">
              <div className="footer_social_links">
                <a
                  href="https://github.com/b l o c k r e c a l l-blockchain"
                  target={"_blank"}
                >
                  <AiFillGithub />
                </a>
              ...
              <div className="footer_social_links">
                <a href="https://t.me/b l o c k r e c a l l" target={"_blank"}>
                  <FaTelegramPlane />
                </a>
              </div>
              <div className="footer_social_links">
            ...
            <div className="text">
              Copyright©2025 | All rights reserved | B L O C K R E C A L L
            </div>
          </section>
        </Container>
